...
#line 21 "/home/aifu/Projects/schizo/src/parser.c"
...
#line 755 "/home/aifu/Projects/schizo/src/parser.c"
        break;
...
#line 73 "/home/aifu/Projects/schizo/src/parser.y"
{ yygotominor.yy0 = yymsp[0].minor.yy0; }
#line 765 "/home/aifu/Projects/schizo/src/parser.c"
        break;
...
#line 770 "/home/aifu/Projects/schizo/src/parser.c"
        break;
...
#line 775 "/home/aifu/Projects/schizo/src/parser.c"
        break;
...
#line 806 "/home/aifu/Projects/schizo/src/parser.c"
        break;
      case 14: /* se_members ::= */
...
#line 823 "/home/aifu/Projects/schizo/src/parser.c"
        break;
...
{ yygotominor.yy0 = PR(LIST(PR(LIST(yymsp[-1].minor.yy0,
									      PR(LIST(LENGTH(yymsp[-2].minor.yy0) == 1 ? HEAD(yymsp[-2].minor.yy0) : yymsp[-2].minor.yy0,
										      PR(LIST(LENGTH(yymsp[0].minor.yy0) == 1 ? HEAD(yymsp[0].minor.yy0) : yymsp[0].minor.yy0,
											 nullptr))))))
								      , nullptr)); }
#line 842 "/home/aifu/Projects/schizo/src/parser.c"
        break;
      case 26: /* binary1 ::= binary1 TOK_OP_BIN1 binary0 */
...
{ yygotominor.yy0 = PR(LIST(PR(LIST(yymsp[-1].minor.yy0,
								PR(LIST(LENGTH(yymsp[-2].minor.yy0) == 1 ? HEAD(yymsp[-2].minor.yy0) : yymsp[-2].minor.yy0,
									PR(LIST(LENGTH(yymsp[0].minor.yy0) == 1 ? HEAD(yymsp[0].minor.yy0) : yymsp[0].minor.yy0,
									   nullptr))))))
								, nullptr)); }
#line 853 "/home/aifu/Projects/schizo/src/parser.c"
        break;
      default:
...
#line 56 "/home/aifu/Projects/schizo/src/parser.y"
...
#line 927 "/home/aifu/Projects/schizo/src/parser.c"
  parserARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
